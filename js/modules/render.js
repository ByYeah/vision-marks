    ...
    function renderFavoritesGrid(mode) {
        ...
        <div class="favorite-grid-item ${gridClass}" data-bookmark-id="${b.id}" title="${escapeHtml(b.title)}">
            ...
            <div class="grid-item-actions">
                <button class="grid-item-btn edit" data-action="edit" data-bookmark-id="${b.id}" title="Editar">✎</button>
                <button class="grid-item-btn delete" data-action="delete" data-bookmark-id="${b.id}" title="Eliminar">×</button>
            </div>
        </div>
    `).join('')}</div>`;
