    ...
    <>
      ...
      <div className="container" onClick={handleOutsideClick}>
        ...
        <div className="item area-5">
          {/* SVG de cierre */}
          {selectedWidgetArea5 && (
            <div className="close-button" onClick={() => handleCloseWidget(5)} title="Cerrar Widget">
              <svg
                width="18px"
                height="18px"
                xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <path
                  fill="#000000"
                  fillRule="evenodd"
                  d="M10.03 6.47c.3.3.3.77 0 1.06l-3.72 3.72h8.19c.95 0 2.37.28 3.56 1.14A5.38 5.38 0 0 1 20.25 17a.75.75 0 0 1-1.5 0c0-1.76-.71-2.78-1.56-3.4a4.84 4.84 0 0 0-2.69-.85H6.31l3.72 3.72a.75.75 0 1 1-1.06 1.06l-5-5a.75.75 0 0 1 0-1.06l5-5c.3-.3.77-.3 1.06 0Z"
                  clipRule="evenodd"
                />
              </svg>
            </div>
        ...
        <div className="item area-6">
          {/* SVG de cierre */}
          {selectedWidgetArea6 && (
            <div className="close-button" onClick={() => handleCloseWidget(6)} title="Cerrar Widget">
              <svg
                width="18px"
                height="18px"
                xmlns="http://www.w3.org/2000/svg"
